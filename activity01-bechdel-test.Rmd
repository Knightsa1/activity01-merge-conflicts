...
If the movie failed the bechel test they usually had a smaller budget and grossed less money domestically and internationally.: 
...
The movies where the women don't talk to each other have the **highest** budget and the gross the most **domestically**.: 
...
There is a higher IQR for the movies that pass the Bechdel test:
