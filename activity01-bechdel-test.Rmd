...
**Respons**: The medains for each group of movies is roughly the same. However the the Inter-quartile range and overall range of the movies that pass the Bechdel test than the others. In fact the a movie that passed the Bechdel test seems to have the highes return on investment.
