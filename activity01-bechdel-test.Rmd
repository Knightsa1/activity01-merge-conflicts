...
**Respones**: If the movie failed the Bechdel test they usually had a smaller budget and grossed less money domestically and internationally.
...
**Response**: The movies where the women don't talk to each other have the **highest** budget and the gross the most **domestically**.
...
**Response**: The medians for each group of movies is roughly the same. However the the Inter-quartile range and overall range of the movies that pass the Bechdel test than the others. In fact the a movie that passed the Bechdel test seems to have the highest return on investment.
